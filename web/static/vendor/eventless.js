...
Elm.Eventless = Elm.Eventless || {};
Elm.Eventless.make = function (_elm) {
   "use strict";
   _elm.Eventless = _elm.Eventless || {};
   if (_elm.Eventless.values) return _elm.Eventless.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var maybeInt = function (decoder) {    return $Json$Decode.oneOf(_U.list([$Json$Decode.$null($Maybe.Nothing),A2($Json$Decode.map,$Maybe.Just,decoder)]));};
   var maybeIntEncoder = function (value) {
      var _p0 = value;
      if (_p0.ctor === "Nothing") {
   ...
   var encodeRule = function (rule) {
      var base = $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "description",_1: $Json$Encode.string(rule.description)}
                                             ,{ctor: "_Tuple2",_0: "expiration",_1: $Json$Encode.$int(rule.expiration)}
                                             ,{ctor: "_Tuple2",_0: "id",_1: $Json$Encode.$int(rule.id)}
                                             ,{ctor: "_Tuple2",_0: "is_active",_1: $Json$Encode.bool(rule.isActive)}]));
      var wrapper = $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "rule",_1: base}]));
      return A2($Json$Encode.encode,0,wrapper);
   };
   var encodeEvent = function (event) {
      var base = $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "event_type",_1: $Json$Encode.string(event.event_type)}
                                             ,{ctor: "_Tuple2",_0: "last_seen",_1: $Json$Encode.string(event.last_seen)}
                                             ,{ctor: "_Tuple2",_0: "rule_id",_1: maybeIntEncoder(event.rule_id)}
                                             ,{ctor: "_Tuple2",_0: "id",_1: $Json$Encode.$int(event.id)}]));
      var wrapper = $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "event",_1: base}]));
      return A2($Json$Encode.encode,0,wrapper);
   };
   var $delete = F2(function (json,url) {
      return {verb: "DELETE",headers: _U.list([{ctor: "_Tuple2",_0: "Content-Type",_1: "application/json"}]),url: url,body: $Http.string(json)};
   });
   var put = F2(function (json,url) {
      return {verb: "PUT",headers: _U.list([{ctor: "_Tuple2",_0: "Content-Type",_1: "application/json"}]),url: url,body: $Http.string(json)};
   });
   var post = F2(function (json,url) {
      return {verb: "POST",headers: _U.list([{ctor: "_Tuple2",_0: "Content-Type",_1: "application/json"}]),url: url,body: $Http.string(json)};
   });
   var parseInt = function (string) {    var _p1 = $String.toInt(string);if (_p1.ctor === "Ok") {    return _p1._0;} else {    return 0;}};
   ...
   var AddError = function (a) {    return {ctor: "AddError",_0: a};};
   var RemoveError = {ctor: "RemoveError"};
   var errorView = F2(function (address,model) {
      var alertBox = function () {
         var _p2 = model.error;
         if (_p2.ctor === "Nothing") {
               return _U.list([$Html.text("")]);
            } else {
               return _U.list([$Html.text(A2($Basics._op["++"],"Oops! ",_p2._0))
                              ,A2($Html.button,
                              _U.list([$Html$Attributes.type$("button"),$Html$Attributes.$class("close"),A2($Html$Events.onClick,address,RemoveError)]),
                              _U.list([$Html.text("x")]))]);
            }
      }();
      return A2($Html.div,_U.list([$Html$Attributes.$class("alert alert-danger")]),alertBox);
   });
   var RefreshEvents = function (a) {    return {ctor: "RefreshEvents",_0: a};};
   var RefreshEvent = {ctor: "RefreshEvent"};
   var updateEvent = function (event) {
      ...
      function (result) {
         ...
         if (_p3.ctor === "Ok") {
               ...
               return AddError($Basics.toString(_p3._0));
            }
      },
      $Task.toResult(A2($Http.send,$Http.defaultSettings,A2(put,encodeEvent(event),A2($Basics._op["++"],"/api/events/",$Basics.toString(event.id)))))));
   };
   var deleteEvent = function (event) {
      ...
      function (result) {
         ...
         if (_p4.ctor === "Ok") {
               ...
               return AddError($Basics.toString(_p4._0));
            }
      },
      $Task.toResult(A2($Http.send,$Http.defaultSettings,A2($delete,encodeEvent(event),A2($Basics._op["++"],"/api/events/",$Basics.toString(event.id)))))));
   };
   var FilterEvent = function (a) {    return {ctor: "FilterEvent",_0: a};};
   var eventFilterForm = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.type$("text")
              ...
              ,A2(onInput,address,FilterEvent)]),
      _U.list([]));
   });
   var navBar = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("navbar navbar-fixed-top navbar-inverse")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("navbar-brand")]),_U.list([$Html.text("Eventless")]))
              ,A2($Html.form,
              _U.list([$Html$Attributes.$class("navbar-form form-inline navbar-right")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("form-group")]),_U.list([A2(eventFilterForm,address,model)]))]))
              ,A2($Html.div,_U.list([]),_U.list([]))]));
   });
   var DissociateEventFromRule = function (a) {    return {ctor: "DissociateEventFromRule",_0: a};};
   var AssociateEventToRule = function (a) {    return {ctor: "AssociateEventToRule",_0: a};};
   var DeleteEvent = function (a) {    return {ctor: "DeleteEvent",_0: a};};
   var eventItem = F2(function (address,event) {
      return A2($Html.tr,
      _U.list([$Html$Attributes.$class("small")]),
      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text($Basics.toString(event.id))]))
              ,A2($Html.td,_U.list([]),_U.list([$Html.text(event.event_type)]))
              ,A2($Html.td,_U.list([]),_U.list([$Html.text(event.last_seen)]))
              ,A2($Html.td,
              _U.list([]),
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-danger btn-xs"),A2($Html$Events.onClick,address,DeleteEvent(event.id))]),
                      _U.list([$Html.text("✖ Delete")]))
                      ,_U.eq(event.rule_id,$Maybe.Nothing) ? A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-success btn-xs"),A2($Html$Events.onClick,address,AssociateEventToRule(event.id))]),
                      _U.list([$Html.text("+ Add to Rule")])) : A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-success btn-xs"),A2($Html$Events.onClick,address,DissociateEventFromRule(event.id))]),
                      _U.list([$Html.text("- Remove from Rule")]))]))]));
   });
   var eventList = F2(function (address,events) {
      var theader = A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("ID")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Event Type")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Last Seen")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Operations")]))]));
      var eventItems = A2($List.map,eventItem(address),events);
      return A2($Html.table,
      _U.list([$Html$Attributes.$class("table table-condensed")]),
      _U.list([A2($Html.thead,_U.list([]),_U.list([theader])),A2($Html.tbody,_U.list([]),eventItems)]));
   });
   var eventView = F2(function (address,model) {
      var searchEvent = function (event) {    return _U.eq(model.searchString,"") || A2($String.contains,model.searchString,event.event_type);};
      var dissociatedEvents = A2($List.filter,searchEvent,A2($List.filter,function (e) {    return _U.eq(e.rule_id,$Maybe.Nothing);},model.events));
      var associatedEvents = A2($List.filter,
      searchEvent,
      A2($List.filter,function (e) {    return _U.eq(e.rule_id,model.selectedRuleID) && !_U.eq(e.rule_id,$Maybe.Nothing);},model.events));
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("panel panel-warning")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("panel-heading")]),
                      _U.list([A2($Html.h3,_U.list([$Html$Attributes.$class("panel-title")]),_U.list([$Html.text("Unruly Events")]))]))
                      ,A2(eventList,address,dissociatedEvents)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("panel panel-info")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("panel-heading")]),
                      _U.list([A2($Html.h3,_U.list([$Html$Attributes.$class("panel-title")]),_U.list([$Html.text("Ruled Events")]))]))
                      ,A2(eventList,address,associatedEvents)]))]));
   });
   var UpdateRuleExpiration = function (a) {    return {ctor: "UpdateRuleExpiration",_0: a};};
   var UpdateRuleDesc = function (a) {    return {ctor: "UpdateRuleDesc",_0: a};};
   var UpdateRule = {ctor: "UpdateRule"};
   var ToggleActiveRule = function (a) {    return {ctor: "ToggleActiveRule",_0: a};};
   var SelectRule = function (a) {    return {ctor: "SelectRule",_0: a};};
   var RefreshRules = function (a) {    return {ctor: "RefreshRules",_0: a};};
   var RefreshRule = {ctor: "RefreshRule"};
   var updateRule = function (rule) {
      ...
      function (result) {
         ...
         if (_p5.ctor === "Ok") {
               ...
               return AddError($Basics.toString(_p5._0));
            }
      },
      $Task.toResult(A2($Http.send,$Http.defaultSettings,A2(put,encodeRule(rule),A2($Basics._op["++"],"/api/rules/",$Basics.toString(rule.id)))))));
   };
   var createRule = function (rule) {
      ...
      function (result) {
         ...
         if (_p6.ctor === "Ok") {
               ...
               return AddError($Basics.toString(_p6._0));
            }
      },
      $Task.toResult(A2($Http.send,$Http.defaultSettings,A2(post,encodeRule(rule),"/api/rules")))));
   };
   var deleteRule = function (rule) {
      ...
      function (result) {
         ...
         if (_p7.ctor === "Ok") {
               ...
               return AddError($Basics.toString(_p7._0));
            }
      },
      $Task.toResult(A2($Http.send,$Http.defaultSettings,A2($delete,encodeRule(rule),A2($Basics._op["++"],"/api/rules/",$Basics.toString(rule.id)))))));
   };
   var EditRule = function (a) {    return {ctor: "EditRule",_0: a};};
   var DeleteRule = function (a) {    return {ctor: "DeleteRule",_0: a};};
   var ruleItem = F3(function (address,selectedRuleID,rule) {
      var setStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "cursor",_1: "pointer"}]));
      var setOnClick = A2($Html$Events.onClick,address,SelectRule(rule.id));
      var isSelected = function () {    var _p8 = selectedRuleID;if (_p8.ctor === "Just") {    return _U.eq(_p8._0,rule.id);} else {    return false;}}();
      return A2($Html.tr,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "bg-primary",_1: isSelected}]))]),
      _U.list([A2($Html.td,_U.list([setOnClick,setStyle]),_U.list([$Html.text($Basics.toString(rule.id))]))
              ,A2($Html.td,_U.list([setOnClick,setStyle]),_U.list([$Html.text(rule.description)]))
              ,A2($Html.td,_U.list([setOnClick,setStyle]),_U.list([$Html.text($Basics.toString(rule.expiration))]))
              ,A2($Html.td,
              _U.list([]),
              _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("checkbox"),$Html$Attributes.checked(rule.isActive),A2($Html$Events.onClick,address,ToggleActiveRule(rule.id))]),
              _U.list([]))]))
              ,A2($Html.td,
              _U.list([]),
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-warning btn-xs"),A2($Html$Events.onClick,address,EditRule(rule.id))]),
                      _U.list([$Html.text("⚙ Modify")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-danger btn-xs"),A2($Html$Events.onClick,address,DeleteRule(rule.id))]),
                      _U.list([$Html.text("✖ Delete")]))]))]));
   });
   var ruleList = F3(function (address,rules,selectedRuleID) {
      var theader = A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("ID")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Name")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Expiration (s)")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Active")]))
              ,A2($Html.th,_U.list([]),_U.list([$Html.text("Operations")]))]));
      var ruleItems = A2($List.map,A2(ruleItem,address,selectedRuleID),rules);
      return A2($Html.table,
      _U.list([$Html$Attributes.$class("table")]),
      _U.list([A2($Html.thead,_U.list([]),_U.list([theader])),A2($Html.tbody,_U.list([]),ruleItems)]));
   });
   var AddRule = {ctor: "AddRule"};
   var ruleForm = F2(function (address,model) {
      return A2($Html.form,
      _U.list([$Html$Attributes.$class("form-horizontal")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("form-group col-lg-6")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("ruleName"),$Html$Attributes.$class("sr-only")]),_U.list([$Html.text("Rule Name")]))
                      ,A2($Html.input,
                      _U.list([$Html$Attributes.type$("text")
                              ,$Html$Attributes.id("ruleName")
                              ,$Html$Attributes.$class("form-control")
                              ,$Html$Attributes.placeholder("Rule Name")
                              ,$Html$Attributes.value(model.ruleDescInput)
                              ,$Html$Attributes.name("description")
                              ,A2(onInput,address,UpdateRuleDesc)]),
                      _U.list([]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("form-group col-lg-4")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("minOccurs"),$Html$Attributes.$class("sr-only")]),_U.list([$Html.text("Min.Occurs")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("input-group")]),
                      _U.list([A2($Html.input,
                              _U.list([$Html$Attributes.type$("number")
                                      ,$Html$Attributes.id("minOccurs")
                                      ,$Html$Attributes.$class("form-control col-lg-5")
                                      ,$Html$Attributes.placeholder("Min. occurrence")
                                      ,$Html$Attributes.value(model.ruleExpirationInput)
                                      ,$Html$Attributes.name("expiration")
                                      ,A2(onInput,address,UpdateRuleExpiration)]),
                              _U.list([]))
                              ,A2($Html.div,_U.list([$Html$Attributes.$class("input-group-addon")]),_U.list([$Html.text("(s)")]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("col-lg-2")]),
              _U.list([_U.eq(model.ruleIDToUpdate,$Maybe.Nothing) ? A2($Html.button,
              _U.list([$Html$Attributes.$class("btn btn-default btn-md"),A2($Html$Events.onClick,address,AddRule)]),
              _U.list([$Html.text("Add Rule")])) : A2($Html.button,
              _U.list([$Html$Attributes.$class("btn btn-info btn-md"),A2($Html$Events.onClick,address,UpdateRule)]),
              _U.list([$Html.text("Update Rule")]))]))]));
   });
   var ruleView = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("panel panel-success")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("panel-heading")]),
              _U.list([A2($Html.h4,_U.list([$Html$Attributes.$class("panel-title")]),_U.list([$Html.text("Rules")]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("panel-body")]),_U.list([A2(ruleForm,address,model)]))
              ,A3(ruleList,address,model.rules,model.selectedRuleID)]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("row")]),_U.list([A2(navBar,address,model)]))
              ,A2(errorView,address,model)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("col-lg-12")]),_U.list([A2(ruleView,address,model),A2(eventView,address,model)]))]))]));
   });
   var NoOp = {ctor: "NoOp"};
   var initialModel = {events: _U.list([])
                      ...
                      ,ruleExpirationInput: ""
                      ,nextRuleID: 3
                      ,ruleIDToUpdate: $Maybe.Nothing
                      ,selectedRuleID: $Maybe.Nothing
                      ,showDissociatedEvents: true
                      ,searchString: ""
                      ,error: $Maybe.Nothing};
   var newEvent = F3(function (event_type,last_seen,id) {    return {event_type: event_type,last_seen: last_seen,rule_id: $Maybe.Nothing,id: id};});
   var newRule = F3(function (description,expiration,id) {    return {description: description,expiration: expiration,id: id,isActive: true};});
   var Rule = F4(function (a,b,c,d) {    return {id: a,description: b,expiration: c,isActive: d};});
   var decodeRule = A5($Json$Decode.object4,
   Rule,
   A2($Json$Decode._op[":="],"id",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"description",$Json$Decode.string),
   A2($Json$Decode._op[":="],"expiration",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"is_active",$Json$Decode.bool));
   var decodeRules = A2($Json$Decode._op[":="],"data",$Json$Decode.list(decodeRule));
   var getRules = $Effects.task(A2($Task.map,
   function (result) {
      var _p9 = result;
      if (_p9.ctor === "Ok") {
            return RefreshRules(_p9._0);
         } else {
            return AddError($Basics.toString(_p9._0));
         }
   },
   $Task.toResult(A2($Http.get,decodeRules,"/api/rules"))));
   var Event = F4(function (a,b,c,d) {    return {id: a,event_type: b,last_seen: c,rule_id: d};});
   var decodeEvents = function () {
      var event = A5($Json$Decode.object4,
      Event,
      A2($Json$Decode._op[":="],"id",$Json$Decode.$int),
      A2($Json$Decode._op[":="],"event_type",$Json$Decode.string),
      A2($Json$Decode._op[":="],"last_seen",$Json$Decode.string),
      A2($Json$Decode._op[":="],"rule_id",maybeInt($Json$Decode.$int)));
      return A2($Json$Decode._op[":="],"data",$Json$Decode.list(event));
   }();
   var getEvents = $Effects.task(A2($Task.map,
   function (result) {
      var _p10 = result;
      if (_p10.ctor === "Ok") {
            return RefreshEvents(_p10._0);
         } else {
            return AddError($Basics.toString(_p10._0));
         }
   },
   $Task.toResult(A2($Http.get,decodeEvents,"/api/events"))));
   var init = {ctor: "_Tuple2",_0: initialModel,_1: $Effects.batch(_U.list([getEvents,getRules]))};
   var update = F2(function (action,model) {
      var _p11 = action;
      switch (_p11.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "UpdateRuleDesc": return {ctor: "_Tuple2",_0: _U.update(model,{ruleDescInput: _p11._0}),_1: $Effects.none};
         case "UpdateRuleExpiration": return {ctor: "_Tuple2",_0: _U.update(model,{ruleExpirationInput: _p11._0}),_1: $Effects.none};
         case "DeleteRule": var _p13 = _p11._0;
           var transformEvent = F2(function (id,event) {    return _U.eq(event.rule_id,$Maybe.Just(id)) ? _U.update(event,{rule_id: $Maybe.Nothing}) : event;});
           var transformEvents = A2($List.map,transformEvent(_p13),model.events);
           var ruleToDelete = $List.head(A2($List.filter,function (r) {    return _U.eq(r.id,_p13);},model.rules));
           var remainingRules = A2($List.filter,function (r) {    return !_U.eq(r.id,_p13);},model.rules);
           var _p12 = ruleToDelete;
           if (_p12.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{rules: remainingRules,events: transformEvents}),_1: deleteRule(_p12._0)};
              }
         case "EditRule": var rule = $List.head(A2($List.filter,function (r) {    return _U.eq(r.id,_p11._0);},model.rules));
           var _p14 = rule;
           if (_p14.ctor === "Nothing") {
                 ...
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {ruleIDToUpdate: $Maybe.Just(_p15.id),ruleDescInput: _p15.description,ruleExpirationInput: $Basics.toString(_p15.expiration)})
                        ,_1: $Effects.none};
              }
         case "SelectRule": var _p17 = _p11._0;
           var _p16 = model.selectedRuleID;
           if (_p16.ctor === "Just") {
                 return _U.eq(_p16._0,_p17) ? {ctor: "_Tuple2",_0: _U.update(model,{selectedRuleID: $Maybe.Nothing}),_1: $Effects.none} : {ctor: "_Tuple2"
                                                                                                                                          ,_0: _U.update(model,
                                                                                                                                          {selectedRuleID: $Maybe.Just(_p17)})
                                                                                                                                          ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{selectedRuleID: $Maybe.Just(_p17)}),_1: $Effects.none};
              }
         case "AddRule": var isInvalid = function (model) {    return $String.isEmpty(model.ruleDescInput) || $String.isEmpty(model.ruleExpirationInput);};
           var ruleToAdd = A3(newRule,model.ruleDescInput,parseInt(model.ruleExpirationInput),model.nextRuleID);
           return isInvalid(model) ? {ctor: "_Tuple2",_0: model,_1: $Effects.none} : {ctor: "_Tuple2"
                                                                                     ,_0: _U.update(model,{ruleDescInput: "",ruleExpirationInput: ""})
                                                                                     ,_1: createRule(ruleToAdd)};
         case "ToggleActiveRule": var ruleToUpdate = $List.head(A2($List.filter,function (r) {    return _U.eq(r.id,_p11._0);},model.rules));
           var _p18 = ruleToUpdate;
           if (_p18.ctor === "Just") {
                 var _p19 = _p18._0;
                 return {ctor: "_Tuple2",_0: model,_1: updateRule(_U.update(_p19,{isActive: $Basics.not(_p19.isActive)}))};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         case "UpdateRule": var isInvalid = function (model) {    return $String.isEmpty(model.ruleDescInput) || $String.isEmpty(model.ruleExpirationInput);};
           var description = model.ruleDescInput;
           var expiration = parseInt(model.ruleExpirationInput);
           var transformRule = function (rule) {
              return _U.eq(model.ruleIDToUpdate,$Maybe.Just(rule.id)) ? _U.update(rule,{description: description,expiration: expiration}) : rule;
           };
           var transformedRules = A2($List.map,transformRule,model.rules);
           var transformedRule = A2($Maybe.withDefault,
           A3(newRule,"",0,0),
           $List.head(A2($List.filter,function (r) {    return _U.eq($Maybe.Just(r.id),model.ruleIDToUpdate);},transformedRules)));
           return isInvalid(model) ? {ctor: "_Tuple2",_0: _U.update(model,{ruleIDToUpdate: $Maybe.Nothing}),_1: $Effects.none} : {ctor: "_Tuple2"
                                                                                                                                 ,_0: _U.update(model,
                                                                                                                                 {ruleDescInput: ""
                                                                                                                                 ,ruleExpirationInput: ""
                                                                                                                                 ,rules: transformedRules
                                                                                                                                 ,ruleIDToUpdate: $Maybe.Nothing})
                                                                                                                                 ,_1: updateRule(transformedRule)};
         case "DeleteEvent": var _p21 = _p11._0;
           var eventToDelete = $List.head(A2($List.filter,function (e) {    return _U.eq(e.id,_p21);},model.events));
           var remainingEvents = A2($List.filter,function (e) {    return !_U.eq(e.id,_p21);},model.events);
           var _p20 = eventToDelete;
           if (_p20.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{events: remainingEvents}),_1: deleteEvent(_p20._0)};
              }
         case "AssociateEventToRule": var _p23 = _p11._0;
           var eventToUpdate = $List.head(A2($List.filter,function (e) {    return _U.eq(e.id,_p23);},model.events));
           var transformEvent = F2(function (id,event) {    return _U.eq(id,event.id) ? _U.update(event,{rule_id: model.selectedRuleID}) : event;});
           var transformedEvents = A2($List.map,transformEvent(_p23),model.events);
           var _p22 = eventToUpdate;
           if (_p22.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{events: transformedEvents}),_1: updateEvent(A2(transformEvent,_p23,_p22._0))};
              }
         case "DissociateEventFromRule": var _p25 = _p11._0;
           var eventToUpdate = $List.head(A2($List.filter,function (e) {    return _U.eq(e.id,_p25);},model.events));
           var transformEvent = F2(function (id,event) {    return _U.eq(id,event.id) ? _U.update(event,{rule_id: $Maybe.Nothing}) : event;});
           var transformedEvents = A2($List.map,transformEvent(_p25),model.events);
           var _p24 = eventToUpdate;
           if (_p24.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{events: transformedEvents}),_1: updateEvent(A2(transformEvent,_p25,_p24._0))};
              }
         case "FilterEvent": return {ctor: "_Tuple2",_0: _U.update(model,{searchString: _p11._0}),_1: $Effects.none};
         case "RefreshEvent": return {ctor: "_Tuple2",_0: model,_1: getEvents};
         case "RefreshEvents": return {ctor: "_Tuple2",_0: _U.update(model,{events: _p11._0}),_1: $Effects.none};
         case "RefreshRule": return {ctor: "_Tuple2",_0: model,_1: getRules};
         case "RefreshRules": return {ctor: "_Tuple2",_0: _U.update(model,{rules: _p11._0}),_1: $Effects.none};
         case "RemoveError": return {ctor: "_Tuple2",_0: _U.update(model,{error: $Maybe.Nothing}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: _U.update(model,{error: $Maybe.Just(_p11._0)}),_1: $Effects.none};}
   });
                           ...
                           return function (i) {
                              return function (j) {
                                 return {events: a
                                        ,rules: b
                                        ,ruleDescInput: c
                                        ,ruleExpirationInput: d
                                        ,nextRuleID: e
                                        ,ruleIDToUpdate: f
                                        ,selectedRuleID: g
                                        ,showDissociatedEvents: h
                                        ,searchString: i
                                        ,error: j};
                              };
                           };
   ...
   return _elm.Eventless.values = {_op: _op
                                  ,Model: Model
                                  ,Event: Event
                                  ,Rule: Rule
                                  ,newRule: newRule
                                  ...
                                  ,ToggleActiveRule: ToggleActiveRule
                                  ,UpdateRule: UpdateRule
                                  ,UpdateRuleDesc: UpdateRuleDesc
                                  ,UpdateRuleExpiration: UpdateRuleExpiration
                                  ,DeleteEvent: DeleteEvent
                                  ,AssociateEventToRule: AssociateEventToRule
                                  ,DissociateEventFromRule: DissociateEventFromRule
                                  ...
                                  ,maybeIntEncoder: maybeIntEncoder
                                  ,maybeInt: maybeInt
                                  ,main: main
                                  ,app: app};
};
